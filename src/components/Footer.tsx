...
const Footer = () => {
  ...
  <footer
  className="relative text-white pt-12 pb-0 px-6 md:px-12 lg:px-24 font-sans border-gray-900 overflow-hidden 
  bg-[#101010] bg-[url('/images/footer-bg-1.png')] bg-cover bg-center bg-no-repeat"
>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_1fr] gap-10 items-start">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="mt-10 flex items-center gap-5">
                  ...
                  <a
                    href="#"
                    className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-black hover:bg-orange-500/80"
                  >
